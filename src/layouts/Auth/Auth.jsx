          ...
          >
            ...
            <Switch>
                ...
                <Route path="/auth/register"  render={(props) => <Register {...props} register={this.props.register}
                                                              ...
                                                              error={this.props.error}
                                                              response={this.props.response}/>}  />
                <Route path="/auth/resetPassword"  render={(props) => <ResetPassword {...props} resetPassword={this.props.resetPassword}
                                                              resetErrors={this.props.resetErrors}
                                                              resetPasswordResult={this.props.resetPasswordResult}
                                                              loading={this.props.loading}
                                                              error={this.props.error}
                                                              response={this.props.response}/>}  />
            </Switch>
